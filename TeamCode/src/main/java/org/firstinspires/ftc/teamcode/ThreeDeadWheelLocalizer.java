...
public final class MecanumDrive {
    public static class Params {
        ...
        // -------------------------------------------------------------------
        //  ODOMETRY POD PARAMETERS (Added for 3-Wheel Odometry)
        // -------------------------------------------------------------------
        
        // goBILDA 4-Bar Pod (48mm wheel) with REV Through Bore Encoder (8192 ticks)
        // 48mm diameter * PI / 25.4 (mm to in) / 8192 ticks per rev
        public double par0InPerTick = 0.0007247738; // Left Pod
        public double par1InPerTick = 0.0007247738; // Right Pod
        public double perpInPerTick = 0.0007247738; // Back (Perpendicular) Pod

        // TODO: Measure these values with a ruler! (in inches)
        // par0Y: Distance from center of robot to Left Pod (Positive Number)
        // par1Y: Distance from center of robot to Right Pod (Negative Number)
        // perpX: Distance from center of robot to Back Pod (Negative if back, Positive if front)
    ...
    // This class replaces the old DriveLocalizer
    public class ThreeDeadWheelLocalizer implements Localizer {
        ...
        public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double par0InPerTick, double par1InPerTick, double perpInPerTick) {
            // TODO: name these exactly what they are in your Control Hub Config (Motors -> left_odo, etc)
        ...
        public PoseVelocity2d update() {
            ...
            FlightRecorder.write("THREE_DEAD_WHEEL_INPUTS", new MecanumLocalizerInputsMessage(
                par0PosVel, par1PosVel, perpPosVel, new PositionVelocityPair(0,0), new YawPitchRollAngles(AngleUnit.RADIANS, 0, 0, 0)
            ));
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // Initialize the new 3-wheel localizer
